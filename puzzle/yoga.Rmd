...
shade(8, 0.05, sides="right", t_calc=0.077565)
```

<h6>Signed Rank Test</h6>
```{r}
t_crit <- qt(1-0.05, 8)
t_stat <- pt(1.42164, 8, lower.tail=FALSE)

shade(8, 0.05, sides="right", t_calc=t_stat)
wilcox.test(df$before, df$after, exact=FALSE, )
```